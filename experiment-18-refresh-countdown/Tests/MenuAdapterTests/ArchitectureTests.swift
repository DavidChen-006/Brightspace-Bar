...
private enum Layout {
    /// `<package root>` — three parents up from `Tests/MenuAdapterTests/<this file>`.
    ...
    static var guiSources: URL { self.packageRoot.appending(path: "Sources/BrightspaceBar") }
    static var contractSources: URL { self.packageRoot.appending(path: "Sources/CourseMenu") }
...
struct ArchitectureTests {
    ...
    /// Backend modules. View code may not name either.
    private static let backendModules: Set<String> = ["MenuAdapter", "CoursePipeline"]
